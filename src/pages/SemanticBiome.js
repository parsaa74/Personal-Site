...
const SemanticBiome = () => {
  ...
  const experimentData = {
    ...
    images: [
      {
        src: `${process.env.PUBLIC_URL}/images/semantic-biome/1.webp`,
      ...
      {
        src: `${process.env.PUBLIC_URL}/images/semantic-biome/2.webp`,
      ...
      {
        src: `${process.env.PUBLIC_URL}/images/semantic-biome/3.webp`,
      ...
      {
        src: `${process.env.PUBLIC_URL}/images/semantic-biome/4.webp`,
        alt: "Visual Poetry",
      ...
      {
        src: `${process.env.PUBLIC_URL}/images/semantic-biome/5.webp`,
        alt: "3D Typography",
