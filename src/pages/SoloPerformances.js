  ...
  const works = [
    {
      ...
      images: [
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/friends/photo_2025-05-01_17-29-01.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/friends/M2RjNjJmMjZk.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/friends/NzIwYjJkZmQ1.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/friends/ZTBjZDc1NzQ4.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/friends/ZTgyOGRjYjRj.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/friends/MGE1ZjJiODcw.webp`,
    ...
    },
    {
      ...
      images: [
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/dissolve/سی پرفورمنس ،سی هنرمند، سی روز 3.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/dissolve/سی پرفورمنس ،سی هنرمند، سی روز 3 (1).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/dissolve/سی پرفورمنس ،سی هنرمند، سی روز 3 (2).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/dissolve/سی پرفورمنس ،سی هنرمند، سی روز 3 (3).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/dissolve/سی پرفورمنس ،سی هنرمند، سی روز 3 (4).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/dissolve/سی پرفورمنس ،سی هنرمند، سی روز 3 (5).webp`,
    ...
    },
    {
      ...
      images: [
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/circle of confusion/photo_2025-05-01_17-25-22.webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/circle of confusion/photo_2025-05-01_17-25-22 (2).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/circle of confusion/photo_2025-05-01_17-25-22 (3).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/circle of confusion/photo_2025-05-01_17-25-22 (4).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/circle of confusion/photo_2025-05-01_17-25-22 (5).webp`,
        ...
        {
          src: `${process.env.PUBLIC_URL}/images/performance/solo performances/circle of confusion/photo_2025-05-01_17-25-22 (6).webp`,
